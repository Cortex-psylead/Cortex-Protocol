...
class TestCDI:
    ...
    def test_soft_violation_z_score_detection(self):
        ...
        # Use coherency=1.0: z-score >> 3 (soft violation triggers) but
        # window_sum = 1.0 < MAX_COHERENCY_SUM_PER_MINUTE (2.5), so the hard
        # threshold check does NOT fire first. Previous value of 5.0 triggered
        # a hard violation before the soft path could be evaluated.
        detector.add_reading(1.0)
